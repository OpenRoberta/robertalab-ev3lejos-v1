...
public class NEPOprog {
    ...
    public void run() throws Exception {
        ...
        hal.turnOnRegulatedMotor(ActorPort.B, 10);
        hal.waitFor(1000);
        hal.drawText(String.valueOf(hal.getRegulatedMotorSpeed(ActorPort.B)), 0, 0);
        hal.waitFor(1000);
        hal.stopRegulatedMotor(ActorPort.B, MotorStopMode.FLOAT);
        hal.setRegulatedMotorSpeed(ActorPort.B, 30);
        hal.waitFor(1000);
        hal.drawText(String.valueOf(hal.getRegulatedMotorSpeed(ActorPort.B)), 0, 2);
        while ( true ) {
