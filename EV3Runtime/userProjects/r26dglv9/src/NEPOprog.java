...
public class NEPOprog {
    ...
    private Set<UsedSensor> usedSensors = new LinkedHashSet<UsedSensor>(Arrays.asList(new UsedSensor(SensorPort.S3, EV3Sensors.EV3_COLOR_SENSOR, ColorSensorMode.RED)));
    ...
    public void run() throws Exception {
        ...
        if ( TRUE ) {
            while ( true ) {
                hal.setRegulatedMotorSpeed(ActorPort.B, hal.getColorSensorRed(SensorPort.S3));
            }
        }
        hal.closeResources();
    }
