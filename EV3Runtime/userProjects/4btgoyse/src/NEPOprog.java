...
public class NEPOprog {
    ...
    private Set<UsedSensor> usedSensors = new LinkedHashSet<UsedSensor>(Arrays.asList(new UsedSensor(SensorPort.S4, EV3Sensors.EV3_ULTRASONIC_SENSOR, UltrasonicSensorMode.DISTANCE)));
    ...
    public void run() throws Exception {
        ...
        boolean TRUE = true;if ( TRUE ) {
            while ( true ) {
                hal.setRegulatedMotorSpeed(ActorPort.B, hal.getUltraSonicSensorDistance(SensorPort.S4));
            }
        }
        hal.closeResources();
    }
