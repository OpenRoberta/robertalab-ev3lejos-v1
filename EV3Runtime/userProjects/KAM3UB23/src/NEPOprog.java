...
public class NEPOprog {
    ...
    public void run() throws Exception {
        ...
        hal.waitFor(2500);
        hal.regulatedDrive(DriveDirection.BACKWARD, 30);
        hal.waitFor(2500);
        hal.stopRegulatedDrive();
        hal.rotateDirectionAngle(TurnDirection.RIGHT, 30, 20);
        hal.rotateDirectionAngle(TurnDirection.LEFT, 30, 20);
        hal.rotateDirectionRegulated(TurnDirection.RIGHT, 30);
        hal.waitFor(2500);
        hal.rotateDirectionRegulated(TurnDirection.LEFT, 30);
        hal.waitFor(2500);
